...
function ogpreview(var1){
    ...
    type : 'POST',
    url  : 'core/og.php',
    data : 'oglinkprev='+ encodeURIComponent(var1),
...
function checkimg(imglink){
  if(!/\.(jpg|gif|png)$/.test((imglink))){
     return  "/img/media/imgerror.jpg";
  }
else {return imglink};
}

function iconrotate(elem,dom){
